          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                ...
                <input type="text" id="nis" name="nis" class="form-control" placeholder="Nis" minlength="0" maxlength="50" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="nisn" class="col-form-label"> Nisn: <span class="text-danger">*</span> </label>
                <input type="text" id="nisn" name="nisn" class="form-control" placeholder="Nisn" minlength="0" maxlength="50" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="nama_lengkap" class="col-form-label"> Nama lengkap: <span class="text-danger">*</span> </label>
                <input type="text" id="nama_lengkap" name="nama_lengkap" class="form-control" placeholder="Nama lengkap" minlength="0" maxlength="250" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
