<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?=base_url('/')?>" class="brand-link">
    <img src="<?= base_url('asset/img/sman5tpi.png') ?>" alt="SIMANIS Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">SIMANIS SMAN 5 TPI</span>
  </a>
