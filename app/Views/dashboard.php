...
<head>
    ...
    <title>Multipurpose - E-Alumni</title>
            ...
            <main>
                ...
                <nav class="navbar navbar-marketing navbar-expand-lg bg-transparent navbar-dark fixed-top">
                    <div class="container px-5">
                        <a class="navbar-brand text-white" href="index.html">E-Alumni</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto me-lg-5">
                                ...
                                <li class="nav-item dropdown dropdown-xl no-caret">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end animated--fade-in-up me-lg-n25 me-xl-n15" aria-labelledby="navbarDropdownDemos">
                                        <div class="row g-0">
                                            <div class="col-lg-5 p-lg-3 bg-img-cover overlay overlay-primary overlay-70 d-none d-lg-block" style="background-image: url('<?=base_url('asset/ui/img/backgrounds/bg-dropdown-xl.jpg')?>)">
                                ...
                                <li class="nav-item dropdown no-caret">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end animated--fade-in-up" aria-labelledby="navbarDropdownDocs">
                                        <a class="dropdown-item py-3" href="https://docs.startbootstrap.com/sb-ui-kit-E-Alumni/quickstart" target="_blank">
                                        ...
                                        <a class="dropdown-item py-3" href="https://docs.startbootstrap.com/sb-ui-kit-E-Alumni/components" target="_blank">
                                        ...
                                        <div class="dropdown-divider m-0"></div>
                                        <a class="dropdown-item py-3" href="https://docs.startbootstrap.com/sb-ui-kit-E-Alumni/changelog" target="_blank">
                            ...
                            <a class="btn fw-500 ms-lg-4 btn-teal" href="<?=base_url('/')?>">
                               Home
                        ...
                        <div class="container px-5">
                            <div class="row gx-5 align-items-center">
                                <div class="col-lg-6" data-aos="fade-up">
                                    <h1 class="page-header-ui-title">E-Alumni SMAN 5 Tanjungpinang</h1>
                                    <p class="page-header-ui-text mb-5"> Merupakan sistem informasi pengelolaan data alumni SMAN 5 Tanjungpinang agar database alumni terstruktur dengan baik.</p>
                    ...
                    <div class="container px-5">
                        ...
                        <div class="row gx-5 justify-content-center text-center">
                            <div class="col-lg-8">
                                ...
                                <a class="btn btn-teal fw-500" href="<?=base_url('/')?>">Home</a>
                            </div>
                        </div>
                    </div>
                    <div class="svg-border-rounded text-white">
        ...
        <div id="layoutDefault_footer">
            <footer class="footer pt-10 pb-5 mt-auto bg-light footer-light">
                <div class="container px-5">
                    <div class="row gx-5">
                        <div class="col-lg-3">
                            <div class="footer-brand">E-Alumni</div>
