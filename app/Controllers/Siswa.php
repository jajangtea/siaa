...
class Siswa extends BaseController
{
	...
	public function getAll()
	{
		...
		foreach ($result as $key => $value) {
			...
			$ops .= '<a id="drop4" class="btn btn-sm dropdown-toggle btn-info" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">';
			$ops .= '<i class="fa-solid fa-pen-square"></i><span class="caret"></span></a>';
			$ops .= '<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">';
			$ops .= '<a class="dropdown-item" onClick="save(' . $value->id . ')"><i class="fa fa-pencil-square-o"></i>   ' .  lang("App.edit")  . '</a>';
			$ops .= '<a class="dropdown-item"><i class="fa fa-copy"></i>   ' .  lang("App.copy")  . '</a>';
			$ops .= '<a class="dropdown-item" onClick="remove(' . $value->id . ')"><i class="fa fa-trash"></i>   ' .  lang("App.delete")  . '</a>';
			$ops .= '</div></div>';
	...
	public function add()
	{
		...
		$this->validation->setRules([
			'nis' => ['label' => 'Nis', 'rules' => 'required|min_length[0]|max_length[50]|is_unique[siswa.nis,id,{id}]'],
			'nisn' => ['label' => 'Nisn', 'rules' => 'required|min_length[0]|max_length[50]|is_unique[siswa.nisn,id,{id}]'],
			'nama_lengkap' => ['label' => 'Nama lengkap', 'rules' => 'required|min_length[0]|max_length[250]'],
